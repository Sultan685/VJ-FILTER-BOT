...
API_ID = int(environ.get('API_ID', '24010752'))
API_HASH = environ.get('API_HASH', 'c6c3a3a638d8f8e8f4fddd14f0aec6fd')
...
# Admins & Users
ADMINS = [int(admin) if id_pattern.search(admin) else admin for admin in environ.get('ADMINS', '1395730131 6525645241').split()] # For Multiple Id Use One Space Between Each.
auth_users = [int(user) if id_pattern.search(user) else user for user in environ.get('AUTH_USERS', '6525645241 1395730131').split()]  # For Multiple Id Use One Space Between Each.
...
CHANNELS = [int(ch) if id_pattern.search(ch) else ch for ch in environ.get('CHANNELS', '-1002665284208').split()]  # For Multiple Id Use One Space Between Each.
...
support_chat_id = environ.get('SUPPORT_CHAT_ID', '-1002937522304')
...
# MongoDB information
DATABASE_URI = environ.get('DATABASE_URI', "mongodb+srv://Testbot2:kaif1344@testbot3.7jpwrlh.mongodb.net/?retryWrites=true&w=majority&appName=Testbot3")   # IF Multiple Database Is False Then Fill Only This Database Url.
...
# Links
GRP_LNK = environ.get('GRP_LNK', 'https://t.me/gghjhigg7')
CHNL_LNK = environ.get('CHNL_LNK', 'https://t.me/+boRxJo-bpWY0OGNl')
SUPPORT_CHAT = environ.get('SUPPORT_CHAT', 'https://t.me/cinemahub756') # Support Chat Link Without https:// or @
OWNER_LNK = environ.get('OWNER_LNK', '@Sultan6shah')
