...
BOT_TOKEN = environ.get('BOT_TOKEN', "6778456107:AAFzQv4YeaBrc7gFbtSOGbxGivZh1PZEvMQ")
...
LOG_CHANNEL = int(environ.get('LOG_CHANNEL', '-1001883750996'))
ADMINS = [int(admin) if id_pattern.search(admin) else admin for admin in environ.get('ADMINS', '1395730131').split()]
CHANNELS = [int(ch) if id_pattern.search(ch) else ch for ch in environ.get('CHANNELS', '-1001721798758').split()]
...
reqst_channel = environ.get('REQST_CHANNEL_ID', '-1001615616214')
REQST_CHANNEL = int(reqst_channel) if reqst_channel and id_pattern.search(reqst_channel) else None
support_chat_id = environ.get('SUPPORT_CHAT_ID', '-1001607170607')
SUPPORT_CHAT_ID = int(support_chat_id) if support_chat_id and id_pattern.search(support_chat_id) else None
INDEX_REQ_CHANNEL = int(environ.get('INDEX_REQ_CHANNEL', LOG_CHANNEL))
FILE_STORE_CHANNEL = [int(ch) for ch in (environ.get('FILE_STORE_CHANNEL', '-1001721798758')).split()]
DELETE_CHANNELS = [int(dch) if id_pattern.search(dch) else dch for dch in environ.get('DELETE_CHANNELS', '0').split()]

# MongoDB information
DATABASE_URI = environ.get('DATABASE_URI', "mongodb+srv://mohdkaif2082:kaif1344@cluster0.pr8z3dx.mongodb.net/?retryWrites=true&w=majority&appName=Cluster0")
...
OWNER_USERNAME = environ.get('OWNER_USERNAME', 'Liza_moviesender_bot') # owner username without @
...
TUTORIAL = environ.get('TUTORIAL', 'https://t.me/c/1998107446/3')
SUPPORT_CHAT = environ.get('SUPPORT_CHAT', 'updates_rrr') # Support Chat Link Without https:// or @
